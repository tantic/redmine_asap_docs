...
## Customize wallpaper images

You can add your own wallpaper by copy them in the folder `<plugin>/assets/images/login/`. Restart your app and the new images will normally appear in the list.